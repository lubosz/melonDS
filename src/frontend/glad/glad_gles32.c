/*
    ...
    OpenGL ES loader generated by glad 0.1.36 on Tue Jan  7 14:40:51 2025.
    ...
    Commandline:
        --profile="core" --api="gles2=3.2" --generator="c" --spec="gl" --local-files --extensions="GL_APPLE_texture_format_BGRA8888,GL_EXT_read_format_bgra"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gles2%3D3.2&extensions=GL_APPLE_texture_format_BGRA8888&extensions=GL_EXT_read_format_bgra
*/

#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "glad_gles32.h"
